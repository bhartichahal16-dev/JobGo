                  ...
                  <tr key={index} className='text-gray-700'>
                     ...
                     <td className='py-2 px-4 border-b relative'>
                      ...
                      ?
                        ...
                        <div className='relative inline-block text-let group'>
                          <button className='text-gray-500 action-button'>...</button>
                           <div className='z-10 hidden absolute right-0 md:left-0 top-0 mt-2 w-32 bg-white borer border-gray-200 rounded shadow group-hover:block'>
